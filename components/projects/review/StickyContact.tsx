...
export const StickyContact = () => {
  return (
    <section className="hidden md:block h-auto my-6">
      <div className="sticky top-[calc(50%-(474px/2))] md:max-w-xs lg:max-w-sm">
        <ContactForm />
      </div>
    </section>
  );
          ...
          <MyCheckbox
            ...
            label={
              <p className="text-xs font-light">
                Acepto y Autorizo el tratamiento de mis datos personales en los
                términos que aparecen a continuación{" "}
                <span className="text-primary-600 hover:underline">aquí.</span>{" "}
                *
              </p>
            }
          />
