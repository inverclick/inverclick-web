  ...
  return (
    <div className="relative flex flex-col md:flex-row gap-3 md:h-[312px] lg:h-[412px] 2xl:h-[612px]">
      <Image
        ...
        width="600"
        height="400"
        className="w-full h-auto md:rounded-l-3xl flex-1 md:w-[312px] lg:h-[412px] 2xl:h-[612px] object-cover"
      />
      <div
      ...
      >
        {restPhotos.map((photo, index) => (
          <Image
            ...
            width="600"
            height="200"
            className={`md:h-[150px] md:w-[200px] lg:h-[200px] lg:w-[300px] 2xl:h-[300px] 2xl:w-[400px] object-cover ${
