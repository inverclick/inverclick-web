...
export const ProjectContent = ({typologies, urbanismPhotos, characteristics, name, description, location, address, city, department, projectLogo, projectId, companyLogo, companyName, housingState, stratum, units, deadline}: DescriptionProps) => {
  return (
              ...
              <div className='flex flex-col gap-3 pb-6'>
                <div className='flex flex-col gap-6 lg:flex-row mt-6'>
                  <div className='flex flex-col gap-2 justify-center items-center'>
                    ...
                    />
                    <p className='text-xs lg:text-sm font-light'>ID&nbsp;Proyecto:&nbsp;<span className='text-primary-600'>{projectId}</span></p>
                  </div>
                  <div className='flex flex-col gap-2'>
                    <p className='font-medium text-2xl lg:text-3xl mb-2'>{name}</p>
