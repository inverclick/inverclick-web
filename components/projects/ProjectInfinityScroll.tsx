...
export const ProjectInfinityScroll = ({ blueprints }: Props) => {
  ...
  return (
    <ScrollArea className="h-[500px] lg:h-[calc(100vh_-_125px)]">
      <div className="w-full mt-4 pb-10 gap-y-6 gap-x-4 xl:gap-x-2 grid justify-items-center [grid-template-columns:repeat(auto-fill,minmax(290px,1fr))] lg:[grid-template-columns:repeat(auto-fill,minmax(220px,1fr))] 2xl:[grid-template-columns:repeat(auto-fill,minmax(290px,1fr))]">
